...
public class ChangedExclusiveMinimum extends ChangedBooleanProperty {

  public ChangedExclusiveMinimum(Boolean oldValue, Boolean newValue, DiffContext context) {
